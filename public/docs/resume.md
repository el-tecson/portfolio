...
Developer focused on building secure, high-performance web applications. Strong in algorithms, system design fundamentals,
and application security principles. Passionate about creating software that is both scalable and resilient. Experienced in
developing full-stack applications using modern JavaScript frameworks, with an emphasis on clean architecture, maintainable
code, and efficient data handling. Continuously learning and applying best practices to deliver reliable and user-focused
solutions.
...
Programming, Graphic Design, Web Design
...
- Earned TESDA NC II (Computer System Servicing)
- Hands-on experience in hardware troubleshooting, OS installation, basic networking, and system maintenance
- Completed practical assessments demonstrating proficiency in diagnostics, repair, and service documentation

## Certificates

- [CS50x Certificate](https://drive.google.com/file/d/1vtbjva9f9m53SQ-LP7HqHSG-GdQ5F51W/view?usp=sharing)
- [National Certificate II (Computer System Servicing)](https://drive.google.com/file/d/1Hay7doMoWePiPX7om6N6hEi9SvlwwTUq/view?usp=sharing)
