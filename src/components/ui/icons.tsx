...
export function Logo({ className, ...props }: Omit<StandardProps, "children">) {
  return <LogoIcon className={className} {...props} />
}

export function BackIcon({ className, ...props }: Omit<StandardProps, "children">) {
  return <RawBackIcon className={className} {...props} />
}

export function CaseStudyIcon({ className, ...props }: Omit<StandardProps, "children">) {
  return <RawCaseStudyIcon className={className} {...props} />
}

export function ChromeWebStoreIcon({ className, ...props }: Omit<StandardProps, "children">) {
  return <RawChromeWebStoreIcon className={className} {...props} />
}

export function FirefoxIcon({ className, ...props }: Omit<StandardProps, "children">) {
  return <RawFirefoxIcon className={className} {...props} />
}

export function LiveDemoIcon({ className, ...props }: Omit<StandardProps, "children">) {
  return <RawLiveDemoIcon className={className} {...props} />
}

export function SourceCodeIcon({ className, ...props }: Omit<StandardProps, "children">) {
  return <RawSourceCodeIcon className={className} {...props} />
}

export function SendIcon({ className, ...props }: Omit<StandardProps, "children">) {
