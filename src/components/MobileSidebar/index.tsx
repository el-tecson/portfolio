  ...
  return (
    <Sheet>
      ...
      >
        ...
        <SidebarList>
          <SidebarListItem watchPath="/">
            Home
          </SidebarListItem>
          <SidebarListItem watchPath="/projects">
            Projects
          </SidebarListItem>
          <SidebarListItem watchPath="/about">
            About
          </SidebarListItem>
          <SidebarListItem watchPath="/contact">
            Contact
          </SidebarListItem>
          <SidebarListItem watchPath="/resume">
            Resume
          </SidebarListItem>
        </SidebarList>
      </SheetContent>
