...
export default async function About() {
  ...
  return (
    <main className="flex flex-col gap-[50px] justify-start bg-bg min-h-screen px-mobile-scr-mg-x py-25 pt-35 sm:px-scr-mg-x">
      ...
      <section className="px-4 py-8 rounded-2xl bg-overlay shadow-sm flex flex-col sm:max-w-[800px] sm:px-10 sm:rounded-4xl self-center" id="about-view">
            <div className="flex flex-col items-center self-center gap-4 sm:gap-8 mb-5">
              ...
              <h2 className="text-2xl font-black text-txt"><AccentText fading={true}>E</AccentText>mmanuel <AccentText fading={true}>L</AccentText>eu <AccentText fading={true}>Tecson</AccentText></h2>
            </div>
            <ReactMarkdown
