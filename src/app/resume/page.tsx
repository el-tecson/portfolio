...
export default async function Resume() {
  ...
  return (
    <main className="flex flex-col gap-[50px] justify-start bg-bg min-h-screen px-mobile-scr-mg-x py-25 pt-35 sm:px-scr-mg-x">
      ...
      <CVCard title="Quick Profile" isHome={false} className="w-full px-4 py-8 rounded-2xl bg-overlay shadow-sm flex flex-col sm:max-w-[800px] sm:px-10 sm:rounded-4xl self-center" >
        <ReactMarkdown
      ...
      <section className="px-4 py-8 rounded-2xl bg-overlay shadow-sm flex flex-col sm:max-w-[800px] sm:px-10 sm:rounded-4xl self-center" id="resume">
          <ReactMarkdown
              remarkPlugins={[remarkGfm]}
              components={{
                  h2: ({ children }) => (
